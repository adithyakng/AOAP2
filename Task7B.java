        ...
        for(int i=0; i<m; i++){
            for(int j=0; j<n; j++){
                ...
                while(low <= high){
                    ...
                    // InValid plots from (i,j) to (i+mid+1,j+mid+1) is the sum of invalid plots from (0,0) to (i+mid+1,j+mid+1) minus the sum of invalid plots from (0,0) to (i,j+mid+1) & (0,0) to (i+mid+1,j) 
